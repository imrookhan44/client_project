...
const FashionPage1 = () => {
    ...
    return (
        <div className='fashionPage1'>
            <h1> פרטי המוצר</h1>
            <div className="fashionPage1-div">
                ...
                <div className="fashionPage1-div-col2">
                    <label htmlFor=""> פרטים נוספים </label>
                    <textarea rows="5"></textarea>
                </div>
                <div className="realstate-btn">
                    <button onClick={() => selectOption("fashionPage2")}>המשך</button>
